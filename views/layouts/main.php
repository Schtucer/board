      ...
      <div class="grid_12">
        ...
        <nav class="">
          <ul class="sf-menu">
            ...
            <?php if(\Yii::$app->user->identity['username'] == 'admin' && \Yii::$app->user->identity['id'] == 1): ?>
                <li><a href="<?= Url::to(['/admin/post/index']) ?>">Админка</a></li>
            <?php endif ?>
            <?php endif ?>
          </ul>
        </nav>
...
<footer>
  <div class="container_12">
    <div class="grid_2">
      <div class="copy"> <a href="<?= Url::home() ?>" class="footer_logo"><img src="/images/logo.png"	alt=""></a> &copy; 2045 <a href="#">Privacy Policy</a> </div>
    </div>    
    <div class="clear"></div>
  </div>  
</footer>
